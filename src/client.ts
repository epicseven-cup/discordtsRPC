...
import {RPCCommands, RPCEvents, RelationshipTypes} from "./rpc_constant";
 ...
 * @prop {string} transport RPC transports. one of `ipc` or `websocket`
 */
...
class RPCClient extends EventEmitter {
    ...
    private user: null;
    private fetch: (method: any, path: any, func: any) => Promise<any>;
    /**
     * @param {RPCClientOptions} [options] Options for the client.
     * You must provide a transports
     */
    constructor(options: Option) {
        ...
        const Transport:Object | undefined = transports.get(this.options.transport);
        if (!Transport) {
        ...
        /**
         * Map of nonces being expected from the transports
         * @type {Map}
         * @private
         */
